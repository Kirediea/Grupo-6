...
df['Tiene_Contrato_Escrito'] = (
    df['Tiene_Contrato_Escrito']
    .astype(str)
    .str.strip()
    .str.lower()
    .str.replace('í', 'i')  # 👈 arregla "sí"
)

# =========================
# 🔹 PRECARIEDAD (TU LÓGICA, SIN INVENTOS)
# =========================
...
# Empleo estable (AHORA SÍ FUNCIONA)
df.loc[
