...
# 🔹 PRECARIEDAD (CONTEO)
st.subheader("⚠️ Distribución de Precariedad")
...
st.markdown("""
- Existe una clara diferencia de ingresos según el tipo de actividad.
- Las zonas presentan desigualdad en el acceso a contratos formales.
- La informalidad reduce significativamente el acceso a beneficios.
- A mayor nivel de precariedad, menores ingresos promedio.
- El subempleo está presente en una proporción relevante de la muestra.
""")